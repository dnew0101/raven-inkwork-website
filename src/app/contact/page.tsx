  ...
  return (
    <div className="flex flex-col justify-center items-center w-full h-auto mt-[5vh]">
      ...
      <p className='text-white text-center mt-6 w-[80%]'>
                <strong><em>*Pssst!*</em></strong> If your looking to book a <strong className="text-indigo-400">tattoo appointment</strong>, please visit the booking form by clicking <a href="https://www.jotform.com" className="underline text-indigo-400">here</a> instead.
      </p>
    </div>
  )
}
